...
CREATE DATABASE `bdd.sql` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `bdd.sql`;
...
INSERT INTO `apprenants` (`ID`, `nom`, `prenom`, `departement`) VALUES
(1,	'PATUROT', 'Adrien', 25),
(2,	'SCHMIDT', 'Adrien', 25),
(3,	'DA SILVA ', 'Jessica', 39),
(4,	'VIGNEAUD', 'Alexandre', 25),
(5,	'DELCROIX', 'Arnaud', 25),
(6,	'DAUBOURG', 'Clovis', 25),
(7,	'LYOUSFI', 'Fouad', 25),
(8,	'BLONDEL', 'Guillaume', 25),
(9,	'PERBET', 'Guillaume', 25),
(10, 'MATHIEU', 'Jérémy', 25),
(11, 'DEVOGHELAERE', 'Lisa', 25),
(12, 'ZERVINI', 'Léa', 25),
(13, 'HOAREAU', 'Sonia', 70),
(14, 'PLUCHART', 'Stéphane', 70),
(15, 'KNORR', 'Vanessa', 25);
...
INSERT INTO `datas` (`id`, `first_name`, `last_name`, `email`, `gender`, `ip_address`, `birth_date`, `zip_code`, `avatar_url`, `state_code`, `country_code`) VALUES
